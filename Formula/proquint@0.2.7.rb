class ProquintAT027 < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "name: proquint_0.2.6_darwin_universal2.tar.gz
c929f87c632062d7d750949f6b1aa37b6866b366d0a545c0d6ef75f36e4305e1"
    end
...
c929f87c632062d7d750949f6b1aa37b6866b366d0a545c0d6ef75f36e4305e1"
  ...
  on_linux do
    on_arm do
      ...
      # sha256: linux_arm64
      sha256 "name: proquint_0.2.6_linux_arm64.tar.gz
7def76a76b613b96e7187928f198940e3304b792c8540afc804f5bf3d08c762a"
    end

    on_intel do
      url "https://github.com/iilei/proquint/releases/download/v#{version}/proquint_#{version}_linux_amd64.tar.gz"
      # sha256: linux_x86_64
      sha256 "name: proquint_0.2.6_linux_x86_64.tar.gz
f7b57abaff5b0da5c413da24e7bd0c86d96b6b21282df5b5505fc01d5e5b927f"
    end
  end
